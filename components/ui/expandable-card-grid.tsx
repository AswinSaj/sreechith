...
export default function ExpandableCardGrid({ items }: ExpandableCardGridProps) {
  ...
  const getDescriptionText = (description: string | Array<{ children?: Array<{ text?: string }> }>): string => {
              ...
              <div>
                <div className="flex justify-between items-start p-4">
                  <div className="">
                    ...
                    >
                      {active.category?.name || 'Film Promo'}
                    </motion.p>
                  </div>
              ...
              <motion.div layoutId={`image-${item.title}-${id}`}>
                <img
                  ...
                  src={item.thumbnail && item.thumbnail.asset?._ref
                    ? urlFor(item.thumbnail).width(300).height(200).fit('crop').url()
                    : `https://img.youtube.com/vi/dQw4w9WgXcQ/maxresdefault.jpg`}
                  alt={item.title}
