...
export default defineType({
  name: 'digitalCorporateFilm',
  title: 'Digital Corporate Film',
  type: 'document',
  fields: [
    defineField({
      name: 'title',
      title: 'Corporate Film Title',
      type: 'string',
      validation: (Rule) => Rule.required(),
      description: 'Title of the digital corporate film'
    }),
    defineField({
      name: 'thumbnail',
      ...
      validation: (Rule) => Rule.required(),
      description: 'Thumbnail image for the corporate film'
    }),
    defineField({
      name: 'description',
      ...
      description: 'Brief description of the corporate film'
    }),
    defineField({
      name: 'videoUrl',
      title: 'Video URL',
